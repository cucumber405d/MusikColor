...
namespace MusikColor.Plugins.Shared;

/// <summary>
/// Общий рендерер "звёздного поля" для тёмного зала с большим экраном:
/// постоянный поток цвета — несколько крупных мягких пятен света,
/// дрейфующих по экрану и смешивающихся аддитивно, как настоящие
...
///
/// Вынесен из ColorFieldVisualizerPlugin в общую библиотеку, чтобы им
/// мог пользоваться и плагин "Генеративная нотация" как фон-подложка.
/// </summary>
public sealed class StarFieldRenderer
{
    ...
    public static readonly SKColor BassColor = new(230, 40, 40);
    public static readonly SKColor MidColor = new(240, 200, 30);
    public static readonly SKColor TrebleColor = new(60, 220, 100);
    public static readonly SKColor SilenceColor = new(30, 70, 230);
